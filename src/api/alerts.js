...
const { REACT_APP_OPEN_PLANNING_API_TOKEN: OPEN_PLANNING_API_TOKEN } = process.env;
const BASE_URL = 'https://cors-anywhere.herokuapp.com/https://api.planningalerts.org.au/applications.js';
